...
public class Place_tab_bathroom {
    ...
    //构造函数
    public Place_tab_bathroom(Student student, ArrayList<Place> lib, Place_tab_appointment place_tab_appointment){
        this.lib = lib;
...
//    }
    ...
    //页面
    public AnchorPane tab_bathroom(){
