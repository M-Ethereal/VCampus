...
//        bBank.setCursor(Cursor.HAND);
        buttonRoot.setTopAnchor(bLib, 245.0);
...
//        bHospital.setGraphic(hap);
        ...
        Image img2 = new Image("/client/Image/HeadPortrait_Admin.png",70, 70,false,true);
//        Image img1 = new Image("client/Image/checkMark.png",60, 60,true,true);
        ImageView iv2 = new ImageView(img2);
        iv2.setLayoutX(291);
        Label userl = new Label("用户管理");
...
//        Navbar.setStyle("-fx-background-color:#50a1f0");
        ...
        //上侧栏
        Label welcome = new Label("欢迎！管理员");
...
//            bHospital.setStyle("-fx-background-color:" + barC);
        ...
        MyInfoHomePageUI_Admin myInfoHomePageUI_admin = new MyInfoHomePageUI_Admin();
        CourseManageHomePageUI_Admin courseManageHomePageUI_admin = new CourseManageHomePageUI_Admin();
//        ShopHomePageUI shopHomePageUI = new ShopHomePageUI();
        LibraryHomePageUI_Admin libraryHomePageUI_admin = new LibraryHomePageUI_Admin();
...
//        childPageHello.setLayoutY(133);
        ...
        childPageMy = myInfoHomePageUI_admin.infoHomePage();
        ...
        childPageCourse = courseManageHomePageUI_admin.CourseHomePageUI();
...
//        childPageBank.setLayoutY(133);
        ...
        childPageLib = libraryHomePageUI_admin.LibHomePage();
...
//
        ...
        root.getChildren().addAll( finalChildPageLib,finalChildPageCourse, finalChildPageMy, finalChildPageHome, mask, buttonRoot, Topbar);
