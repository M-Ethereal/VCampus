...
public class Hospital_tab_query {
    ...
    public Hospital_tab_query(Student student){
    ...
    public FlowPane advicesListGenerate(ArrayList<MedicalAdvice> adviceList ) {
        ...
        for (int i = 0; i < adviceList.size(); i++) {
            ...
            Label docName = new Label(advice.getDocName());
            Label docDept = new Label(advice.getQueryDept());
...
//            CName.setVisible(false);
            ...
            docDept.setStyle("-fx-font-size:15px");
            docDept.setLayoutX(150);
            docDept.setLayoutY(43);

            queryDate.setStyle("-fx-font-size:15px");
            queryDate.setLayoutX(250);
            ...
            Qbutton.getChildren().addAll(docName, docDept, queryDate, ques);
            ...
            Qbutton.addEventHandler(MouseEvent.MOUSE_PRESSED, e-> {
                ...
                adviceDetailPage = new Hospital_jump_MedicalAdviceInfo(advice, this).medicalAdviceInfo();
    ...
    public Tab TabAdviceList(){
        ...
        msgSendToServer_q.setMessageType(MessageType.stu_advice_query_stu);
        msgSendToServer_q.setExtraMessage(student.getId());
