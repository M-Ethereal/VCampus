...
public class Place_tab_library {
    ...
    //构造函数
    public Place_tab_library(Student student, ArrayList<Place> lib, Place_tab_appointment place_tab_appointment){
        this.lib = lib;
