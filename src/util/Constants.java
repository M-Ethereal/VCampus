...
public final class Constants {
    ...
    //Chat-Constants
    public static final String chatLogin = "CHAT_LOGIN";	//启动消息
    public static final String chatInit = "CHAT_INIT";		//回传历史消息
    public static final String allMembers = "全体成员";
    public static final String chatQuery = "CHAT_QUERY";	//询问有无更新消息
    public static final String chatSend = "CHAT_SEND";		//发送消息
    public static final String chat_msg = "CHAT_MSG";		//接受普通消息
    public static final String sign_out = "SIGN_OUT";		//退出聊天
